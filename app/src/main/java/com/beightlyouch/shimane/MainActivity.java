...
public class MainActivity extends AppCompatActivity{
    ...
    public void startQuiz(ArrayList<Integer> choices,int answer_num){
        ...
        yamanashi_city.setImageURI(Uri.parse("android.resource://com.beightlyouch.shimane/drawable/" + poolcity[0][answer_city]));
    ...
    public void checkAnswer(final int answer_city, final int answer_num){
        choice_one.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (answer_num == 0) {
                    yamanashi_result.setImageURI(Uri.parse("android.resource://com.beightlyouch.shimane/drawable/" + "correct"));
                    correct++;
                    answercheck[problem-1] = 1;
                } else {
                    yamanashi_result.setImageURI(Uri.parse("android.resource://com.beightlyouch.shimane/drawable/" + "wrong"));
