...
public class CustomRecyclerAdapter extends RecyclerView.Adapter<ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        if(check[position] == 0){
            holder.result_correct.setImageURI(Uri.parse("android.resource://com.beightlyouch.shimane/drawable/notright"));
        }else if(check[position] == 1){
            holder.result_correct.setImageURI(Uri.parse("android.resource://com.beightlyouch.shimane/drawable/right"));
        }
